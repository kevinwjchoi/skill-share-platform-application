...
function ProjectCard({ project, handleDeleteProject, showApplicationForm, setShowApplicationForm, setSelectedProject, userApplicationProjectIDs, showAddProjectButton, setShowAddProjectButton }) {
